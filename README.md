...
<head>
    ...
    <title>Sistema de Control de Costos y Márgenes - Licorera</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🍾 Sistema de Control de Costos y Márgenes</h1>
            <p>Gestión Integral para Licorera</p>
        </div>
        
        <div class="tabs">
            <button class="tab active" onclick="showTab('costos-fijos', this)">💰 Costos Fijos</button>
            <button class="tab" onclick="showTab('productos', this)">📦 Productos y Márgenes</button>
            <button class="tab" onclick="showTab('analisis', this)">📊 Análisis de Precios</button>
            <button class="tab" onclick="showTab('export', this)">💾 Exportar Datos</button>
        </div>
            ...
            <div class="section">
                ...
                <table id="costos-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input type="text" value="Servicios públicos" /></td>
                ...
                <button class="btn btn-success" onclick="agregarCostoFijo()">➕ Agregar Nuevo Costo</button>
        ...
        <!-- TAB 2: PRODUCTOS Y MÁRGENES -->
        <div id="productos" class="tab-content">
            <div class="section">
                <h3>Gestión de Productos y Cálculo de Márgenes</h3>
                <div class="alert">
                    <strong>💡 Importante:</strong> El margen de contribución unitario es independiente de las unidades vendidas. Representa la ganancia por cada unidad después de cubrir los costos variables.
                </div>
                
                <!-- SECCIÓN DE CARGA MASIVA -->
                <div class="card" style="margin-bottom: 30px; background: #f8f9fa; border: 2px dashed #007bff;">
                    <h4 style="color: #007bff; margin-bottom: 15px;">📁 Carga Masiva de Productos</h4>
                    <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 20px; align-items: center;">
                        <div>
                            ...
                            <button class="btn btn-success" onclick="procesarArchivo()" style="margin: 5px 0;">📤 Subir Productos</button>
                            <button class="btn" onclick="limpiarTabla()" style="margin: 5px 0;">🗑️ Limpiar Tabla</button>
                        </div>
                        <div>
                            <p><strong>¿No tienes plantilla? Descarga el formato:</strong></p>
                            <button class="btn" onclick="descargarPlantilla()" style="margin: 5px 0;">📋 Descargar Plantilla Excel</button>
                ...
                <table id="productos-table">
                    <thead>
                        <tr>
                            ...
                            <th>Precio Venta ($)</th>
                            <th>Margen Contribución Unitario ($)</th>
        ...
        <div id="analisis" class="tab-content">
            <div class="section">
                ...
                <div class="card">
                    <h4>Configuración de Márgenes Deseados</h4>
                    <p><strong>Margen mínimo recomendado:</strong> <input type="number" id="margen-minimo" value="40" style="width: 80px;"> %</p>
                ...
                <button class="btn" onclick="actualizarAnalisis()">🔄 Actualizar Análisis</button>
                ...
                <div class="section">
                    ...
                    <div class="card">
                        ...
                        <div class="alert">
                            <strong>Recomendación:</strong> Para cubrir los costos fijos, necesitas generar aproximadamente <strong>$12.4 millones</strong> en ventas mensuales con la mezcla actual de productos.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="export" class="tab-content">
            <div class="export-section">
                ...
                <div class="grid">
                    ...
                    <div class="card">
                        <h4>📦 Productos y Márgenes</h4>
                        <p>Exporta el análisis completo de productos</p>
                ...
                <div class="section">
                    ...
                    <div class="alert">
                        <strong>Cómo usar los archivos CSV en Excel:</strong><br>
                        1. Abre Excel y ve a "Datos" → "Obtener datos" → "Desde archivo" → "Desde texto/CSV"<br>
                        2. Selecciona el archivo descargado<br>
                        3. Configura el delimitador como "coma" si es necesario<br>
                        4. Las fórmulas se recrearán automáticamente
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function showTab(tabName, element) {
            ...
            // ✅ CORRECCIÓN: Forzar actualización cuando se abre la pestaña de análisis
            if (tabName === 'analisis') {
        ...
        // Calcular totales de costos fijos (versión ultra segura)
        ...
        // Calcular margen de cada producto (versión más robusta)
        function calcularMargen(input) {
            ...
            try {
                ...
                // Margen de contribución unitario (independiente de unidades)
                ...
                // Contribución total (sí depende de unidades)
        ...
        // Calcular total de contribución mensual
        function calcularTotalContribucionMensual() {
            ...
            productos.forEach(row => {
                ...
                // ✅ CORRECCIÓN: Verificar que el elemento existe antes de leerlo
            ...
            // También actualizar el elemento anterior para mantener compatibilidad
        ...
        // Calcular análisis de márgenes unitarios (versión segura)
        function calcularAnalisisMargenesUnitarios() {
            const productos = document.querySelectorAll('#productos-table tbody tr');
            
            // ✅ CORRECCIÓN: Verificar si hay productos antes de calcular
            ...
            productos.forEach(row => {
                ...
                // ✅ CORRECCIÓN: Verificar que los elementos existen
        ...
        function eliminarFila(button) {
            ...
            // ✅ CORRECCIÓN: Actualizar punto de equilibrio al eliminar filas
            calcularPuntoEquilibrio();
        }
        ...
        function actualizarAnalisis() {
            ...
            // ✅ CORRECCIÓN: Forzar actualización del punto de equilibrio
            calcularPuntoEquilibrio();
        }
        ...
        function descargarPlantilla() {
            ...
            mostrarEstado('✅ Plantilla descargada. Llena los datos y súbela nuevamente.', 'success');
        }
        ...
        async function procesarArchivo() {
            ...
            try {
                ...
                mostrarEstado(`✅ ${data.length} productos cargados exitosamente.`, 'success');
        ...
        // Procesar archivo CSV (versión más robusta)
        ...
        // Procesar archivo Excel (simulado - en producción usaríamos una librería como SheetJS)
            ...
            return new Promise((resolve, reject) => {
                ...
                reader.onload = function(e) {
                    try {
                        ...
                        reject(new Error('Los archivos Excel requieren una librería adicional. Por favor usa el formato CSV.'));
                    } catch (error) {
        ...
        function cargarProductosMasivo(productos) {
            ...
            if (!tbody) {
                mostrarEstado('❌ Error: No se pudo acceder a la tabla de productos.', 'error');
                return;
            }
        ...
        function limpiarTabla() {
            ...
            // ✅ CORRECCIÓN: Resetear valores a cero de forma segura
            ...
            mostrarEstado('🗑️ Tabla limpiada. Puedes cargar nuevos productos.', 'info');
        }
